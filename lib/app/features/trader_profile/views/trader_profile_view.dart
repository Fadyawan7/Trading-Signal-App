      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text('Achievements', style: TextStyle(fontWeight: FontWeight.w600)),
            const SizedBox(height: 6),
            ...[
              {
                'icon': '🏆',
                'title': 'Top Trader 2025',
                'desc': 'Ranked #12 globally',
              },
              {
                'icon': '⭐',
                'title': 'Verified Expert',
                'desc': 'Platform verified',
              },
