...
class UserProfileView extends GetView<UserProfileViewModel> {
  ...
  Widget build(BuildContext context) {
    const groups = [
      {'id': '1', 'name': 'Crypto Elite Signals', 'avatar': '🚀', 'joined': 'Jan 2026'},
      {'id': '2', 'name': 'Forex Masters Club', 'avatar': '💎', 'joined': 'Feb 2026'},
      {'id': '3', 'name': 'Gold Trading Pro', 'avatar': '⚡', 'joined': 'Mar 2026'},
    ];
        ...
        child: ListView(
          ...
          children: [
            Row(
              ...
              children: [
                const Text('Profile', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600)),
              ],
            ),
            ...
            MarketPanel(
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      ...
                      const Expanded(
                        child: Column(
                          ...
                          children: [
                            Text('Alex Smith', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                            SizedBox(height: 2),
                            Text('alex.smith@email.com', style: TextStyle(fontSize: 12, color: AppColors.mutedText)),
                            SizedBox(height: 8),
                  ...
                  const Row(
                    children: [
                      Expanded(child: _Metric(label: 'Groups', value: '3')),
                      SizedBox(width: 8),
                      Expanded(child: _Metric(label: 'ROI', value: '+47%', green: true)),
                      SizedBox(width: 8),
                      Expanded(child: _Metric(label: 'Signals', value: '156', primary: true)),
                    ],
                  ),
                ],
              ),
            ...
            //   children: [
            //     const Text('My Groups', style: TextStyle(fontWeight: FontWeight.w600)),
            //     InkWell(onTap: () => Get.toNamed(AppRoutes.explore), child: const Text('View All →', style: TextStyle(fontSize: 12, color: AppColors.primary))),
            //   ],
            // ),
            ...
            //                 child: Text(g['avatar']! as String, style: const TextStyle(fontSize: 22)),
            //               ),
            //               const SizedBox(width: 10),
            //               Expanded(
            //                 child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            //                   Text(g['name']! as String, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600)),
            //                   Text('Joined ${g['joined']}', style: const TextStyle(fontSize: 11, color: AppColors.mutedText)),
            //                 ]),
            //               ),
            //               Container(
            //                 padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
            //                 decoration: BoxDecoration(color: Colors.green.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(8)),
            //                 child: const Text('Active', style: TextStyle(color: Colors.green, fontSize: 10, fontWeight: FontWeight.w600)),
            //               ),
            //             ],
            //           ),
            //         ),
...
class _Metric extends StatelessWidget {
  const _Metric({required this.label, required this.value, this.green = false, this.primary = false});
  final String label;
  final String value;
  final bool green;
  final bool primary;
  @override
  Widget build(BuildContext context) {
    final color = green ? Colors.green : (primary ? AppColors.primary : Colors.white);
    return Container(
        ...
        child: Column(
          children: [
            Container(
              width: 44,
              height: 44,
              decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), gradient: const LinearGradient(colors: [AppColors.primary, AppColors.accent])),
              child: Icon(icon),
            ),
            const SizedBox(height: 8),
